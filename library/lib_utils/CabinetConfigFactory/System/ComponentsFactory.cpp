...
CUSTOM_COMPONENTS_ITERATOR_CABINET(IMPLEMENT_COMPONENT_ID_GETTERS)
...
{
    CUSTOM_COMPONENTS_ITERATOR_CABINET(ADD_COMPONENT_NAME_TO_ID_TO_MAP)
};
...
{
    CUSTOM_COMPONENTS_ITERATOR_CABINET(ADD_COMPONENT_ID_TO_NAME_TO_MAP)
};
...
COMPONENT_FACTORY_NAMESPACE::ComponentsFactory::CreateComponent(const pugi::xml_node& inputData)
{
    ...
    switch(componentId)
    {
        CUSTOM_COMPONENTS_ITERATOR_CABINET(IMPLEMENT_COMPONENT_LOADER)
...
COMPONENT_FACTORY_NAMESPACE::ComponentsFactory::CreateComponent(const std::string& name)
{
    ...
    switch(componentId)
    {
        CUSTOM_COMPONENTS_ITERATOR_CABINET(IMPLEMENT_COMPONENT_CREATOR)
...
COMPONENT_FACTORY_NAMESPACE::ComponentsFactory::AutoMerge(const egt::IBaseComponentPtr& lowPriorityCompPtr, const egt::IBaseComponentPtr& highPriorityCompPtr)
{
    ...
    switch(compId)
    {
        CUSTOM_COMPONENTS_ITERATOR_CABINET(IMPLEMENT_COMPONENT_MERGER)
...
COMPONENT_FACTORY_NAMESPACE::ComponentsFactory::GetFactoryHash()
{
    ...
    if (false == hashReady)
    {
        ...
        CUSTOM_COMPONENTS_ITERATOR_CABINET(COMP_FACTORY_HASH_CALC)

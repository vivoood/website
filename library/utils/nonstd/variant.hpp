#ifndef NONSTD_VARIANT_VISITOR_HPP
#define NONSTD_VARIANT_VISITOR_HPP
...
#endif // NONSTD_VARIANT_VISITOR_HPP
...
struct NONSTD_VARIANT_DEPRECATED static_visitor
{
    using result_type = R;
...
public:
    ...
    auto VARIANT_INLINE match(Fs&&... fs) const
        -> decltype(variant::visit(*this, ::nonstd::make_visitor(std::forward<Fs>(fs)...)))
    {
        return variant::visit(*this, ::nonstd::make_visitor(std::forward<Fs>(fs)...));
    }
    // non-const
    template <typename... Fs>
...
#ifndef NONSTD_VARIANT_IO_HPP
#define NONSTD_VARIANT_IO_HPP

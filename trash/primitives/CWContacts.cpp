...
{
    WidgetData::SContacts * p = dynamic_cast<WidgetData::SContacts*> ( pD );
    if ( p != nullptr )
    {
    ...
    {
        this->addWidget ( new Wt::WText ( "CWContacts can't get SContacts from IWidgetData for user: " + pD->strHash ) );
    }
}
